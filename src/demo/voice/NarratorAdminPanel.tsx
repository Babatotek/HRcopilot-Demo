    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-3xl bg-white dark:bg-slate-900 rounded-[28px] shadow-2xl border border-slate-200 dark:border-white/10 overflow-hidden"
        >
          {/* ── Header ── */}
          <div className="px-8 py-6 border-b border-slate-100 dark:border-white/5 flex items-center justify-between bg-gradient-to-r from-violet-600/10 to-purple-600/5">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-violet-600 to-purple-700 flex items-center justify-center text-white text-lg shadow-lg shadow-violet-500/30">
                🎙️
              </div>
              <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-violet-100 dark:bg-violet-500/20 text-violet-700 dark:text-violet-300">
          ...
          <div className="p-8 space-y-6 max-h-[80vh] overflow-y-auto">
                    ...
                    <button
                      ...
                      className={`relative p-4 rounded-2xl border-2 text-left transition-all duration-200 ${
                        isActive
                          ...
                          : 'border-slate-200 dark:border-white/10 hover:border-violet-300 dark:hover:border-violet-500/40 bg-white dark:bg-white/5'
                      }`}
                    >
                      ...
                      {isActive && (
                        <div className="absolute bottom-2 right-2 w-2 h-2 rounded-full bg-violet-500 shadow-[0_0_6px_rgba(139,92,246,0.8)]" />
                      )}
                    </button>
                  );
                })}
            ...
            <div className="bg-slate-50 dark:bg-white/5 rounded-2xl p-5 border border-slate-200 dark:border-white/10">
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500/30 resize-none mb-3"
              />
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                onClick={store.closeAdminPanel}
                className="px-5 py-2.5 bg-violet-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-violet-700 transition-colors shadow-lg shadow-violet-500/20"
              >
                Save & Close
              </button>
            </div>
      ...
      className={`
        ...
        ${isSpeaking
          ...
          : isBusy
            ...
            : 'bg-violet-600 hover:bg-violet-700 hover:scale-105 active:scale-95 text-white shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 cursor-pointer'
        }
      `}
    >
      {/* Icon */}
