...
const MODES: ModeCard[] = [
  {
    id:       'guided',
    icon:     '✨',
    title:    'HR360 At A Glance',
    tagline:  'The full story in under 12 minutes',
    details:  [
      'See every module — live, narrated, explained',
      'Payroll slip, procurement & leakage ROI included',
      'Discover exactly what your org is losing today',
      'Ends with a personalised proposal request',
    ],
    duration:  '10–12 min',
    gradient:  'from-violet-50 to-indigo-100/80',
