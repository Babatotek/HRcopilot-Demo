    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9000] flex items-center justify-center p-4">
          ...
          >
            {/* Header */}
            <div className="p-4 md:p-8 pb-3 md:pb-4 flex justify-between items-start gap-3 border-b border-slate-200 dark:border-white/10 flex-shrink-0">
              <div className="flex items-center gap-3 md:gap-4 min-w-0">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#0047cc] to-[#0035a0] rounded-2xl flex items-center justify-center shadow-sm flex-shrink-0">
                  <span className="text-xl md:text-2xl text-white">📊</span>
                </div>
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-1.5 mb-1">
                    <h2 className="text-base md:text-xl font-black text-slate-900 dark:text-white uppercase tracking-widest">
                  ...
                  <p className="text-xs md:text-sm font-medium text-slate-500 dark:text-slate-400 truncate">
                    20 employees · Technology · ₦115.8M payroll
                  </p>
                </div>
              </div>
              <button
                onClick={onClose}
                className="p-2.5 md:p-3 bg-slate-100 dark:bg-white/5 rounded-full hover:bg-slate-200 dark:hover:bg-white/10 transition-colors shadow-sm flex-shrink-0"
              >
