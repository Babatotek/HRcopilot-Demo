 ...
 * All AI-powered features for HR360 — powered by Groq (llama-3.3-70b-versatile).
 *
...
export async function extractDocumentMetadata(text: string): Promise<DocumentMetadata> {
  const fallback: DocumentMetadata = {
    summary:     'Document auto-indexed by HR360 Cabinet AI.',
    tags:        ['document', 'record', 'hr360'],
    category:    'General',
    sensitivity: 'INTERNAL',
    entities:    ['HR360 System'],
  };
...
const HR_ADVISOR_SYSTEM = `You are an expert HR advisor built into HR360, an enterprise HR platform.
...
export async function generateHRAssistantResponse(
  ...
  if (!client) {
    ...
    return "I'm your HR360 AI Advisor. I can help with payroll, attendance, leave, performance, and more. What would you like to know?";
  }
...
export async function generateFormTemplate(prompt: string): Promise<GeneratedFormTemplate> {
  const fallback: GeneratedFormTemplate = {
    ...
    description: 'Auto-generated by HR360 AI.',
    sections: [{
