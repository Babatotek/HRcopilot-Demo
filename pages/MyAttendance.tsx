  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      {(() => {
        ...
        return (
        <div className="bg-slate-800 dark:bg-slate-900 rounded-[32px] p-8 text-white flex justify-between items-center shadow-2xl">
            ...
            return (
              <div 
                ...
                className={`h-40 rounded-2xl border flex flex-col items-center justify-center relative transition-all hover:shadow-lg cursor-pointer p-4 text-center ${
                  ...
                  status.type === 'HOLIDAY' ? 'bg-purple-50 border-purple-200 text-purple-700 shadow-sm' :
