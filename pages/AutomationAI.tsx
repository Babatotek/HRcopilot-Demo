                  ...
                  {PROCESS_STEPS.map((step, i) => (
                    <React.Fragment key={i}>
                      <div className="flex flex-col items-center gap-3 w-32 group">
                        <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-2xl group-hover:border-[#0047cc]/50 group-hover:scale-110 transition-all relative">
                           {step.icon}
                           {i === 0 && <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#0047cc] rounded-full border-2 border-[#0f172a] shadow-[0_0_8px_#0047cc]" />}
                        </div>
              ...
              {AI_TOOLS.map((tool, i) => (
                <div key={i} className="space-y-3 pb-6 border-b border-white/5 last:border-0 last:pb-0">
                  <div className="flex items-start justify-between">
                    ...
                    {i === 0 && <span className="text-[#0047cc] text-xs">+</span>}
                  </div>
                  <button className="w-full py-2 bg-[#0047cc]/10 text-[#0047cc] text-[9px] font-black uppercase tracking-widest rounded-xl border border-[#0047cc]/20 hover:bg-[#0047cc] hover:text-white transition-all">
                    {tool.action}
                  </button>
                </div>
              ))}
