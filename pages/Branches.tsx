          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
               ...
               <div className="flex flex-col items-center justify-center p-8 bg-slate-50 dark:bg-white/[0.02] border border-dashed border-slate-200 dark:border-white/10 rounded-[32px] gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-slate-100 dark:bg-white/5 flex items-center justify-center text-3xl opacity-40">🏗️</div>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <GlassCard title="Identity Distribution">
                      <div className="h-64 flex flex-col justify-center items-center relative">
                        <div className="w-40 h-40 rounded-full border-[8px] border-white/5 flex items-center justify-center relative">
                           <div className="absolute inset-0 rounded-full border-[8px] border-indigo-500 border-t-transparent -rotate-45" />
                        ...
                        <div className="mt-8 flex gap-6">
                           <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-indigo-500" /> <span className="text-[9px] font-black text-slate-400 uppercase">Core</span></div>
                   ...
                   <GlassCard title="Asset Integrity">
                      <div className="space-y-4">
                         ...
                         <div className="flex justify-between items-center p-4 bg-white/5 rounded-2xl border border-white/5">
                            <div className="flex gap-3 items-center">
                               <div className="w-10 h-10 rounded-xl bg-[#0047cc]/10 flex items-center justify-center text-xl shadow-lg">🛡️</div>
                               <div>
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/10 pb-6">
        <div>
          <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase italic">Distributed <span className="text-[#0047cc]">Infrastructure</span></h2>
          <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em] mt-1 italic tracking-tighter">Enterprise Node Management & Geospatial Governance</p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-[#0047cc] text-white font-black text-[11px] uppercase tracking-widest rounded-2xl shadow-xl shadow-purple-500/20 active:scale-95 transition-all"
          >
            + Provision New Hub
          </button>
        </div>
