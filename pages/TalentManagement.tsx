  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase italic">Talent <span className="text-[#0047cc]">Management</span></h2>
        </div>
        <button 
          onClick={() => setIsManualCreateModalOpen(true)}
          className="px-6 py-2.5 bg-[#0047cc] hover:bg-[#0035a0] text-white font-black text-[11px] uppercase tracking-widest rounded-xl shadow-lg shadow-blue-500/20 active:scale-95 transition-all flex items-center gap-2 group"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          ...
          { label: 'Active Onshore Days', val: '8', footer: 'View List', icon: '🏝️', color: 'text-[#0047cc]', accent: '#0035a0' },
        ].map((stat, i) => (
      ...
      <AnimatePresence>
        {isManualCreateModalOpen && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            >
              <div className="p-10 border-b border-slate-100 dark:border-white/5 flex justify-between items-center bg-slate-50/50 dark:bg-white/[0.02]">
                <div>
              ...
              <div className="p-10 border-t border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02] flex justify-end gap-4">
                <button 
                  onClick={() => setIsManualCreateModalOpen(false)}
