...
const Finance: React.FC = () => {
  ...
  const renderInvoiceModal = () => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <GlassCard className="w-full max-w-4xl relative z-10 !p-0 overflow-hidden shadow-2xl border-none">
        <div className="p-8 border-b border-slate-100 dark:border-white/5 flex justify-between items-center bg-white dark:bg-slate-900">
          <div>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { 
            ...
            status: 'OUTPERFORM', 
            accent: '#8b5cf6', // Purple to match sample
            trend: '+4.2%',
          ...
          <GlassCard key={i} accentColor={kpi.accent} className="!p-5 hover:shadow-lg transition-all group">
      ...
      {activeSubTab === 'CASH_FLOW' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <GlassCard id="finance-chart" className="lg:col-span-8 !p-10 relative overflow-hidden group">
            <div className="relative z-10">
              <div className="flex justify-between items-center mb-10">
                <div>
                  <h3 className="text-2xl font-black uppercase tracking-tighter italic">Capital Flow Analytics</h3>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em] mt-2">Simulated Multi-Entity Treasury Forecast</p>
                </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <GlassCard className="!p-8 bg-gradient-to-br from-[#0047cc] to-[#002b7a] border-none text-white relative overflow-hidden group">
               <div className="relative z-10">
                 <p className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-200/60 mb-2">Consolidated Assets</p>
                 <h4 className="text-4xl font-black italic tracking-tighter mb-6">$4,280,500</h4>
                 <div className="flex items-center gap-3 py-4 border-t border-white/10">
                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                       <svg className="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" strokeWidth="3"/></svg>
                    </div>
            ...
            <GlassCard className="!p-8 bg-white dark:bg-[#0d0a1a] shadow-xl">
               <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-2">Total Liabilities</p>
               <h4 className="text-4xl font-black italic tracking-tighter text-slate-900 dark:text-white mb-6">$1,120,400</h4>
               <div className="flex items-center gap-3 py-4 border-t border-slate-100 dark:border-white/5">
                  <div className="w-8 h-8 rounded-full bg-rose-500/10 flex items-center justify-center">
                     <svg className="w-4 h-4 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 17h8m0 0v-8m0 8l-8-8-4 4-6-6" strokeWidth="3"/></svg>
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-rose-500">+2.1% Expenditure</span>
               </div>
            </GlassCard>

            <GlassCard className="!p-8 bg-white dark:bg-[#0d0a1a] shadow-xl border-t-[6px] border-[#8b5cf6]">
               <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 mb-2">Net Income (QTD)</p>
               <h4 className="text-4xl font-black italic tracking-tighter text-[#8b5cf6] mb-6">$840,200</h4>
               <div className="w-full bg-slate-100 dark:bg-white/5 h-2 rounded-full overflow-hidden">
                  <div className="h-full bg-[#8b5cf6] w-[84%] shadow-[0_0_12px_rgba(139,92,246,0.5)]" />
               </div>
            </GlassCard>
          </div>
        </div>
           ...
           <GlassCard className="!p-10">
              ...
              <div className="space-y-12">
                 {[
                    ...
                    { label: '31-60 Days', value: 180000, color: '#8b5cf6', pct: 21 },
      ...
      {activeSubTab === 'KPIS' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           {[
              ...
              { label: 'ROI (Project X)', value: '24.5%', goal: '15.0%', status: 'HIGH', color: '#8b5cf6' },
      ...
      {activeSubTab === 'JOURNAL_ENTRIES' && (
        <GlassCard className="p-8">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-lg font-black uppercase tracking-widest italic">Recent Journal Entries</h3>
            <button 
              onClick={() => setIsEntryModalOpen(true)}
              className="px-4 py-2 bg-[var(--brand-primary)] text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-lg shadow-purple-500/20 hover:scale-105 transition-transform"
            >
              New Entry
            </button>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-slate-100 dark:border-white/5">
                  ...
                  <th className="pb-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Debit</th>
                  <th className="pb-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Credit</th>
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-white/5">
                {journalEntries.map((entry) => (
                  <tr key={entry.id} className="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-all group cursor-pointer">
                    <td className="py-5 text-xs font-bold text-slate-500">{new Date(entry.date).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}</td>
                    <td className="py-5">
                      <div className="flex items-center gap-3">
                         <div className="w-8 h-8 rounded-lg bg-slate-50 dark:bg-white/5 flex items-center justify-center text-xs group-hover:bg-[#0047cc]/10 group-hover:text-[#0047cc] transition-colors">
                            {entry.description.toLowerCase().includes('payroll') ? '👥' : '📜'}
                         </div>
                         <div>
                            <p className="text-xs font-black uppercase tracking-tight">{entry.description}</p>
                            <p className="text-[9px] text-slate-400 font-bold uppercase mt-1 flex items-center gap-1">
                               <span className="opacity-50">Ref:</span> {entry.id}
                               <span className="mx-1">•</span>
                               <span className="opacity-50">Source:</span> Manual Entry
                            </p>
                         </div>
                      </div>
                    </td>
                    <td className="py-5 text-xs font-black text-emerald-500 font-mono">${entry.totalDebit?.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                    <td className="py-5 text-xs font-black text-rose-500 font-mono">${entry.totalCredit?.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                    <td className="py-5">
                      <div className="flex items-center gap-2">
                         <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase ${
                           entry.status === 'POSTED' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-amber-500/10 text-amber-500'
                         }`}>
                           {entry.status}
                         </span>
        ...
        <div className="space-y-8">
          <div className="flex justify-between items-center">
             ...
             <button 
               ...
               className="px-6 py-3 bg-[#0047cc] text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
             >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             {[
                { label: 'Total Assets', value: accounts.filter(a => a.type === 'Asset').reduce((sum, a) => sum + (a.balance || 0), 0), icon: '🏦', accent: '#10b981' },
                { label: 'Total Liabilities', value: accounts.filter(a => a.type === 'Liability').reduce((sum, a) => sum + (a.balance || 0), 0), icon: '💳', accent: '#f43f5e' },
                { label: 'Equity Stake', value: accounts.filter(a => a.type === 'Equity').reduce((sum, a) => sum + (a.balance || 0), 0), icon: '💎', accent: '#8b5cf6' },
             ].map((stat, i) => (
                <GlassCard key={i} accentColor={stat.accent} className="!p-6 flex items-center gap-6">
                   <div className="w-14 h-14 rounded-2xl bg-white dark:bg-white/5 flex items-center justify-center text-2xl shadow-inner">{stat.icon}</div>
                   <div>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">{stat.label}</p>
                      <p className="text-2xl font-black italic tracking-tighter">${Math.abs(stat.value).toLocaleString(undefined, { minimumFractionDigits: 2 })}</p>
                   </div>
                </GlassCard>
             ))}
          </div>
          ...
          <GlassCard className="p-8 border-none bg-slate-50/50 dark:bg-white/[0.02]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
               <div>
                  <h3 className="text-[11px] font-black uppercase tracking-tighter italic text-slate-500">Chart of Accounts</h3>
                  <p className="text-[9px] text-slate-400 font-bold uppercase mt-1">Enterprise Ledger Registry • {accounts.length} Active Accounts</p>
               </div>
               <div className="flex w-full md:w-auto gap-3">
                  <div className="relative flex-1 md:w-64">
                     <input 
                        ...
                        className="w-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-widest focus:ring-2 focus:ring-[#0047cc] transition-all"
                     />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {accounts.map(account => {
                const balanceColor = account.balance >= 0 ? 'text-[#0047cc]' : 'text-rose-500';
                const typeIcon = account.type === 'Asset' ? '🏦' : account.type === 'Liability' ? '💳' : account.type === 'Equity' ? '💎' : account.type === 'Revenue' ? '📈' : '📉';
                const progress = Math.min(Math.abs(account.balance) / 2000000 * 100, 100);
                
                return (
                  <div key={account.id} className="p-6 bg-white dark:bg-slate-900/50 rounded-[28px] border border-slate-100 dark:border-white/5 hover:shadow-2xl hover:border-[#0047cc]/40 transition-all group overflow-hidden relative flex flex-col justify-between">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-[#0047cc]/5 rounded-bl-[80px] -mr-8 -mt-8 group-hover:bg-[#0047cc]/10 transition-colors" />
                    
                    <div>
                      <div className="flex justify-between items-start mb-6">
                        <div className="w-10 h-10 bg-slate-50 dark:bg-white/5 rounded-xl flex items-center justify-center text-xl shadow-inner group-hover:scale-110 transition-transform group-hover:rotate-12">{typeIcon}</div>
                        <div className="text-right">
                           <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">{account.code}</span>
                           <span className={`px-2 py-0.5 rounded-lg text-[8px] font-black uppercase ${
                              account.type === 'Asset' ? 'bg-emerald-500/10 text-emerald-500' :
                              account.type === 'Liability' ? 'bg-rose-500/10 text-rose-500' :
                              'bg-purple-500/10 text-purple-500'
                           }`}>{account.type}</span>
                        </div>
                      </div>

                      <h4 className="text-xs font-black uppercase tracking-tight mb-1 group-hover:text-[#0047cc] transition-colors line-clamp-2 h-8">{account.name}</h4>
                      <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-6">{account.group}</p>

                      <div className="space-y-3">
                         <div className="flex justify-between items-end">
                            <div>
                               <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest mb-0.5">Account Balance</p>
                               <p className={`text-lg font-black italic tracking-tighter ${balanceColor}`}>${Math.abs(account.balance).toLocaleString(undefined, { minimumFractionDigits: 2 })}</p>
                            </div>
                            <div className="text-right pb-1">
                               <span className="text-[8px] font-black text-emerald-500 uppercase flex items-center gap-1">
                                  <svg className="w-2 h-2" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z"/></svg>
                                  Ready
                               </span>
                            </div>
                         </div>
                         ...
                         <div className="h-1.5 w-full bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
                            <div 
                               className="h-full bg-[#0047cc] rounded-full transition-all duration-1000 group-hover:shadow-[0_0_12px_rgba(0,71,204,0.5)]" 
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/5 flex gap-2 invisible group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all opacity-0 group-hover:opacity-100">
                       <button className="flex-1 py-2.5 rounded-lg bg-slate-50 dark:bg-white/10 text-[8px] font-black uppercase tracking-widest hover:bg-[#0047cc] hover:text-white transition-all">Details</button>
                       <button className="px-3 py-2.5 rounded-lg bg-slate-50 dark:bg-white/10 text-[8px] font-black uppercase tracking-widest hover:bg-[#0047cc] hover:text-white transition-all">Audit</button>
                    </div>
                  </div>
                );
              })}
        ...
        <div className="space-y-6">
           <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center bg-slate-900 dark:bg-white p-8 rounded-[32px] gap-6">
              <div className="flex items-center gap-6">
                 <div className="w-16 h-16 bg-[#0047cc] rounded-2xl flex items-center justify-center text-white text-3xl shadow-xl shadow-blue-500/20">⚖️</div>
                 <div>
           ...
           <GlassCard className="!p-0 overflow-hidden border-2 border-slate-100 dark:border-white/5">
             <div className="p-10 border-b border-slate-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-slate-50/50 dark:bg-white/[0.01]">
               <div>
  ...
  const renderAccountsReceivable = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Total Outstanding', value: '$1,240,500', accent: '#8b5cf6', trend: '+12.4%', trendColor: 'text-emerald-500' },
  ...
  const renderAccountsPayable = () => (
    <div className="space-y-6">
      ...
      {activeSubTab === 'VENDOR_BILLS' && (
        <GlassCard className="p-8 border-none bg-rose-50/10 dark:bg-white/[0.02]">
          <div className="flex justify-between items-center mb-10">
            <div>
        ...
        <div className="space-y-6">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-8">
                 <GlassCard className="p-10 border-none bg-slate-50/50 dark:bg-white/[0.02]">
           ...
           <GlassCard className="!p-10 border-none bg-[#0047cc]/5 dark:bg-white/[0.02]">
              <div className="flex justify-between items-center mb-10">
                 <h4 className="text-sm font-black uppercase tracking-tighter italic flex items-center gap-3">
                    <span className="w-10 h-10 rounded-xl bg-[#0047cc] flex items-center justify-center text-white shadow-lg shadow-blue-500/20">🏛️</span>
      ...
      {activeSubTab !== 'BALANCE_SHEET' && activeSubTab !== 'INCOME_STATEMENT' && activeSubTab !== 'CONSOLIDATION' && activeSubTab !== 'TAX_REPORTS' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            { id: 'TAX_REPORTS', title: 'Compliance Engine', icon: '🏛️', desc: 'Sovereign tax obligations and audit readiness metrics.', color: 'amber' },
          ].map((report, i) => (
  ...
  const renderFixedAssets = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          { label: 'Asset Valuation (Gross)', value: '$92,000', accent: '#8b5cf6', trend: 'Audit Verified', trendColor: 'text-emerald-500' },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight uppercase italic">Accounting & <span className="text-[#0047cc]">Finance</span></h2>
      ...
      {isEntryModalOpen && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <GlassCard className="w-full max-w-3xl p-0 max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-8 border-b border-slate-100 dark:border-white/5 flex justify-between items-center sticky top-0 bg-white dark:bg-[#0d0a1a] z-10">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    className="flex-1 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                    placeholder="e.g. Monthly Rent Payment"
                  />
                  <button 
                    type="button"
                    onClick={handleAiCategorize}
                    className="px-4 bg-purple-500/10 text-purple-500 border border-purple-500/20 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-purple-500/20 transition-all"
                  >
                    AI Suggest
                  </button>
                </div>
                {aiSuggestion && (
                  <div className="p-3 bg-purple-500/5 border border-purple-500/10 rounded-xl flex justify-between items-center animate-in fade-in slide-in-from-top-2">
                    <div className="text-[10px]">
                      <span className="font-black text-purple-500 uppercase">AI Suggestion:</span>
                    ...
                    <button 
                      ...
                      className="text-[9px] font-black text-purple-500 uppercase hover:underline"
                    >
                      Apply
                    </button>
                  </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button 
                  ...
                  className={`flex-1 px-6 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest text-white transition-all ${
                    isBalanced ? 'bg-[var(--brand-primary)] shadow-lg shadow-purple-500/20 hover:scale-[1.02]' : 'bg-slate-300 dark:bg-white/10 cursor-not-allowed opacity-50'
                  }`}
                >
                  Post Entry
                </button>
